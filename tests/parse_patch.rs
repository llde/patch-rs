use chrono::DateTime;
use patch::{File, FileMetadata, ParseError, ParseErrorOut, Patch};

use pretty_assertions::assert_eq;

#[test]
fn test_parse() -> Result<(), ParseErrorOut<'static>> {
    let sample = "\
--- before.py
+++ after.py
@@ -1,4 +1,4 @@
...
#[test]
fn test_parse_no_newline_indicator() -> Result<(), ParseErrorOut<'static>> {
    let sample = "\
--- before.py
+++ after.py
@@ -1,4 +1,4 @@
...
#[test]
fn test_parse_timestamps() -> Result<(), ParseErrorOut<'static>> {
    let sample = "\
...
#[test]
fn test_parse_other() -> Result<(), ParseErrorOut<'static>> {
    let sample = "\
...
#[test]
fn test_parse_escaped() -> Result<(), ParseErrorOut<'static>> {
    let sample = "\
--- before.py \"asdf \\\\ \\n \\t \\0 \\r \\\" \"
